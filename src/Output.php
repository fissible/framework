...
class Output
{
    ...
    public function error(string $string = ''): void
    {
        ...
        $this->pipes['err']->write(rtrim($string) . PHP_EOL);
    }
        ...
        foreach ($array as $y => $row) {
            if (!$printedCols) {
                ...
                foreach ($row as $x => $char) {
                    $out->write(substr(str_pad($x . '', $col_width, ' ', STR_PAD_RIGHT), 0, $col_width));
                }
                $printedCols = true;
            }
