...
use Fissible\Framework\Exceptions\InvalidFileModeException;
...
final class FileTest extends TestCase
{
    ...
    {
        $this->expectException(\Fissible\Framework\Exceptions\FileNotFoundException::class);
    ...
    public function testFilesMatch()
    {
        ...
        $OptionTestFiles = $UnitDir->filesMatch(function ($File) {
            return preg_match('/\AA/', $File->getFilename()) === 1;
        });
        ...
        $this->assertContains('ApplicationTest.php', $fileNames);
        $this->assertContains('ArrTest.php', $fileNames);
        $this->assertNotContains('CollectionTest.php', $fileNames);
    }
